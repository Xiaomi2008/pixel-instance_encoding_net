...
class ResNeXt(nn.Module):
    ...
    @property
    def name(self):
        return 'Resnet50_b{}_c{}'.format(self.baseWidth,self.cardinality)


def resnext50(baseWidth, cardinality,num_class=1000):
    """
...
# def RestNext50():
#     return resnext50(16, 5, 2)

if __name__ == '__main__':
    net=resnext50(16, 5, 2)
    y = net(Variable(torch.randn(1,4,224,224)))
    print(y.size())
    print(y)